...
train_data_loader = data_loader(train_data_path, batch_size, patch_size, augmentation=True, preload_all_image=False)
val_data_loader   = data_loader(val_data_path  , batch_size, patch_size, augmentation=True, preload_all_image=False)
